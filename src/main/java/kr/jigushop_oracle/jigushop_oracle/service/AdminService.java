...
//                ItemForm.builder()
//                    .category_id(101L)
//                    .item_name("노세범 샴푸바 (지성용)")
//                    .brand("솝퓨리")
//                    .item_option("")
//                    .item_desc("지성 두피용 샴푸, 린스 기능을 담은 올인원 약산성 샴푸바입니다.")
...
//                    .item_name("납작한 대나무칫솔")
//                    .brand("지구샵")
//                    .item_option("일반용, 어린이용")
//                    .item_desc("더 가볍고 얇은, 납작한 버전의 대나무칫솔입니다.")
...
//                    .brand("소락")
//                    .item_option("")
//                    .item_desc("일회용 화장솜을 대체하는 다회용 면화장솜입니다")
...
//                ItemForm.builder()
//                    .category_id(101L)
//                    .item_name("오리지널고체치약 150정입")
//                    .brand("지구샵")
//                    .item_option("")
//                    .item_desc("제로웨이스트 양치시간에 대한 지구샵의 진심을 담은 오리지널 고체치약입니다. 한 알씩 집어 사용하는 편리함까지 더한 제로웨이스트 양치시간, 지금 시작해요:)")
...
//                ItemForm.builder()
//                    .category_id(101L)
//                    .item_name("올바른 샴푸바 중건성용 100g")
//                    .brand("동구밭")
//                    .item_option("")
//                    .item_desc("청결한 두피를 위한 각질케어 기능성의 자몽향이 매력적인 순식물성 샴푸바입니다.")
...
//                ItemForm.builder()
//                    .category_id(101L)
//                    .item_name("올바른 아기비누 알로에")
//                    .brand("동구밭")
//                    .item_option("")
//                    .item_desc("순한 성분에 깔끔한 세정력, 무향까지! 아이들 뿐 아니라 향에 민감하셨던 지구주민들에게도 추천해요!")
...
//                    .brand("더험블코리아")
//                    .item_option("")
//                    .item_desc("종이상자에 담아 플라스틱케이스를 줄이고 식물성 왁스로 코팅된 민트 비건 치실")
//                    .img("https://cdn.imweb.me/thumbnail/20230615/ae49170fa8570.jpg")
//                    .price(5900L)
//                    .build(),
//
//                ItemForm.builder()
...
//                    .item_name("칫솔꽂이")
//                    .brand("노플라스틱선데이")
//                    .item_option("하늘, 보라, 검정")
//                    .item_desc("재사용플라스틱으로 만들어진 칫솔꽂이 입니다.")
...
//                ItemForm.builder()
//                    .category_id(101L)
//                    .item_name("재사용 플라스틱 알약커팅기")
//                    .brand("지구샵")
//                    .item_option("초록, 파랑, 빨강, 검정")
//                    .item_desc("고체치약을 작게 쪼개서 사용하시던 지구주민님의 의견에 귀기울여 탄생한 알약커팅기! 순환된 병뚜껑 20개가 알약커팅기로 재탄생되었어요. 고체치약 뿐만 아니라 다양한 알약도 자를 수 있답니다.")
...
//                ItemForm.builder()
//                    .category_id(102L)
//                    .item_name("설거지비누 150g")
//                    .brand("리앤에코")
//                    .item_option("")
//                    .item_desc("주방에서 발생하는 플라스틱 쓰레기를 줄이고 발달장애인의 경제적 자립을 생각한 식물성 원료로만 만들어진 설거지 비누입니다.")
...
//                ItemForm.builder()
//                    .category_id(102L)
//                    .item_name("재사용 플라스틱 밀봉클립")
//                    .brand("지구샵")
//                    .item_option("초록, 파랑, 빨강, 검정")
//                    .item_desc("순환된 병뚜껑 5개가 밀봉 클립으로 재탄생! 종이봉투, 비닐봉투를 끼워서 고정시켜 밀봉해보세요.")
...
//                ItemForm.builder()
//                    .category_id(102L)
//                    .item_name("천연 물방울 수세미")
//                    .brand("지구샵")
//                    .item_option("")
//                    .item_desc("물방울 모양으로 가공한 천연 수세미입니다. 면 고리가 달려 있어 보관이 용이해요. (낱개 제품)")
...
//                ItemForm.builder()
//                    .category_id(102L)
//                    .item_name("유기농 핸드타월 (3매)")
//                    .brand("지구샵")
//                    .item_option("GOTS 인증 받은 유기농 면으로 만들어진 핸드타월입니다.")
//                    .item_desc("")
...
//                ItemForm.builder()
//                    .category_id(102L)
//                    .item_name("유기농 배색 그물 장바구니")
//                    .brand("지구샵")
//                    .item_option("")
//                    .item_desc("지구샵과 연남점, 그로서리 매장의 포인트를 담은 유기농 그물장바구니에요. 일상 곳곳에서 비닐이나 일회용 제품 대신 사용하며 제로웨이스트 라이프, 지구샵과 함께해요!")
...
//                    .brand("지구샵")
//                    .item_option("")
//                    .item_desc("천연재료로 짜여진 라탄 티코스터입니다. 핸드메이드 제품으로, 자연스러운 분위기를 연출할 수 있어요. 컵, 작은 그릇, 소품, 악세사리 등을 올려두는 다용도 소품으로 활용해보세요.")
...
//                    .brand("소렉스")
//                    .item_option("")
//                    .item_desc("텀블러 등과 같은 긴 용기를 세척하기에 용이한 세척솔입니다")
...
//                ItemForm.builder()
//                    .category_id(102L)
//                    .item_name("손편한 앞접시세트(5개입)")
//                    .brand("탄소창고")
//                    .item_option("")
//                    .item_desc("손잡이가 있고 가벼워 캠핑이나 피크닉, 가정에서도 사용하기 좋은 CXP 소재의 앞접시 입니다.")
...
//                    .brand("소락")
//                    .item_option("")
//                    .item_desc("플라스틱 FREE! 미세플라스틱 걱정 없이 재사용 가능한 소창티백입니다.")
